...
impl<'a> InventoryAnnouncement<'a> {
  ...
  #[inline]
  pub fn inventory(&self) -> flatbuffers::Vector<flatbuffers::ForwardsUOffset<InventoryItem<'a>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<flatbuffers::ForwardsUOffset<InventoryItem<'a>>>>>(InventoryAnnouncement::VT_INVENTORY, None).unwrap()
  }
}

pub struct InventoryAnnouncementArgs<'a> {
    pub inventory: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a , flatbuffers::ForwardsUOffset<InventoryItem<'a >>>>>,
}
...
impl<'a: 'b, 'b> InventoryAnnouncementBuilder<'a, 'b> {
  #[inline]
  pub fn add_inventory(&mut self, inventory: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<InventoryItem<'b >>>>) {
...
impl<'a> InventoryRequest<'a> {
  ...
  #[inline]
  pub fn inventory(&self) -> flatbuffers::Vector<flatbuffers::ForwardsUOffset<InventoryItem<'a>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<flatbuffers::ForwardsUOffset<InventoryItem<'a>>>>>(InventoryRequest::VT_INVENTORY, None).unwrap()
  }
}
...
impl<'a> flatbuffers::Follow<'a> for InventoryItem<'a> {
    type Inner = InventoryItem<'a>;
    #[inline]
    fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
        Self {
            _tab: flatbuffers::Table { buf: buf, loc: loc },
...
impl<'a> InventoryItem<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args InventoryItemArgs<'args>) -> flatbuffers::WIPOffset<InventoryItem<'bldr>> {
      let mut builder = InventoryItemBuilder::new(_fbb);
  ...
  pub fn type_(&self) -> InventoryItemType {
    self._tab.get::<InventoryItemType>(InventoryItem::VT_TYPE_, Some(InventoryItemType::Error)).unwrap()
  }
  #[inline]
  pub fn hash(&self) -> Hash<'a> {
    self._tab.get::<flatbuffers::ForwardsUOffset<Hash<'a>>>(InventoryItem::VT_HASH, None).unwrap()
  }
}

pub struct InventoryItemArgs<'a> {
    pub type_: InventoryItemType,
    pub hash: Option<flatbuffers::WIPOffset<Hash<'a >>>,
}
impl<'a> Default for InventoryItemArgs<'a> {
    #[inline]
    fn default() -> Self {
        InventoryItemArgs {
...
pub struct InventoryItemBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> InventoryItemBuilder<'a, 'b> {
  #[inline]
  pub fn add_type_(&mut self, type_: InventoryItemType) {
    self.fbb_.push_slot::<InventoryItemType>(InventoryItem::VT_TYPE_, type_, InventoryItemType::Error);
  }
  #[inline]
  pub fn add_hash(&mut self, hash: flatbuffers::WIPOffset<Hash<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Hash>>(InventoryItem::VT_HASH, hash);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> InventoryItemBuilder<'a, 'b> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<InventoryItem<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, InventoryItem::VT_HASH,"hash");
    flatbuffers::WIPOffset::new(o.value())
  }
}
